...
var allTexts = {
  followSub: "Met deze knoppen kan je een kanaal volgen of erop abonneren. Er is een groot verschil tussen deze twee. Volgen kan je vergelijken met abonneren \
  ...
  panels kijken of daarnaar vragen aan de mods of de streamer zelf.",
  channelInfo: "In deze balk kan je redelijk wat dingen zien en naar toe gaan. Als eerste zie je links de naam van de channel die je aan het kijken bent met het \
  ...
  hoeveel mensen de streamer zelf volgt.",
  aanbevolen: "Dit deel van de website laat een aantal aanbevolen kanalen zien. Deze kanalen kunnen kanalen zijn die je recent hebt gezien of kanalen die lijken op \
  andere kanalen die je recent hebt gezien. Het is altijd handig om een kijkje te nemen bij deze streams, misschien zit er wat leuks tussen!",
  infoPanels: "In deze panels kan je allemaal zien wat een streamer te zeggen heeft over zijn stream. Hier kan onderanderen staan welke dagen en tijde de streamer \
  ...
  te lezen voordat je gaat chatten.",
  feed: "Dit is de feed. Hier kunnen streamers updates achterlaten. Dit kunnen updates zijn over wanneer ze gaan streamen of misschien over iets totaal anders. \
  ...
  dus je zal het niet altijd op elk kanaal terugvinden.",
  meerTwitch: "Meer op Twitch is een kleine zijbalk met verschillende links die je meer informatie kunnen geven. Dit is eigenlijk niet echt iets waar je veel mee \
  doet, maar je kan altijd een kijkje nemen voor meer informatie over dat deel.",
  volgenBladeren: "Dit zijn waarschijnlijk wel twee van de belangrijkste dingen op Twitch. Als je op volgend drukt, kan je alle kanalen zien die jij hebt gevolgd. \
  ...
  vrienden: "Vrienden is een feature op Twitch waarbij je met anderen bevriend kan raken. Zodra je bevriend met iemand bent, kan je het zien wanneer deze persoon \
  ...
  zegt, omdat niet altijd iedereen zin heeft om te chatten.",
  titleGame: "Hier kan je heel makkelijk en overzichtelijk zien wat de titel van de stream is en welke game er wordt gespeeld op het moment. Ook zie je naast \
  ...
  streamers die ook deze game spelen of onder dezelfde community streamen.",
  playerVod: "Dit is de player. Als de stream live is kan je hier alle actie bekijken. Als de stream offline is, zie je de balk erboven staan. Deze balk heeft een \
  ...
  vanaf het punt waar je was gestopt  .",
  chat: "De chat is HET belangrijkste deel van heel Twitch. Hier kan jij namelijk met andere mensen en de stream praten. Hierdoor kan je invloed hebben op de stream \
  ...
  houden. Zij kunnen berichten verwijderen en mensen verbannen. Denk dus goed na voordat je wat zegt in de chat.",
  login: "Hier kan je al jou informatie zien zodra je bent ingelogd. Het is altijd wel handig om te kijken wat alles precies is, zodat je weet waar je alles kan \
  vinden."
}
